...
export default function RegisterPage({ onRegisterSuccess, onNavigateToLogin, onNavigateToLanding }) {
  ...
  // Initialize Google Identity Services 1-Click Signup button
  useEffect(() => {
  ...
  return (
    <div style={{
      ...
      <div className="saas-card" style={{
        ...
        {/* Google 1-Click Sign-Up Container */}
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px' }}>
          <div id="google-signup-btn-container" ref={googleBtnRef} style={{ width: '100%', minHeight: '44px', display: 'flex', justifyContent: 'center' }} />
