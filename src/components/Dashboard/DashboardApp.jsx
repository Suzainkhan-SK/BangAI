        ...
        if (status === 'COMPLETED' || status === 'VIDEO_COMPLETED') {
          ...
          setPastShorts(prev => prev.map(t => {
            ...
            return {
              ...
              ytUploadStatus: data.ytUploadStatus || data.story?.ytUploadStatus || t.ytUploadStatus || null,
              ytProcessingStatus: data.ytProcessingStatus || data.story?.ytProcessingStatus || t.ytProcessingStatus || null,
              bytesUploaded: data.bytesUploaded ?? data.story?.bytesUploaded ?? t.bytesUploaded ?? null,
          ...
          {activeThread && activeThread.status === 'WORKFLOW_INACTIVE' && !isGenerating && (
            <div className="saas-card animate-float" style={{
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px' }}>
                <a href="https://cmpunktg23.app.n8n.cloud/workflow/8gjIDzachTHImGke" target="_blank" rel="noopener noreferrer" className="btn-glow" style={{ fontSize: '12px', padding: '7px 16px', gap: '6px', textDecoration: 'none', display: 'inline-flex', alignItems: 'center' }}>
